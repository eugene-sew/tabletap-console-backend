...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,test.localhost,*.localhost', cast=lambda v: [s.strip() for s in v.split(',')])
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='tabletap_console'),
